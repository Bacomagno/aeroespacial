...
<div class="breadcrumb-holder">
    <div class="container-fluid">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo IP_SERVER ?>crinactivos">Cursos Inactivos</a></li>
        </ul>
    </div>
</div>
<section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header>
            <h1 class="h3 display">Cursos Inactivos            </h1>
          </header>
          <div class="form-group row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <p>En esta sección encuentra en listado de Cursos Inactivos             </p>
                  </div>
                </div>
          </div>
          <form action="<?php echo IP_SERVER?>crinactivos " method="POST" id="cursos_fechas" enctype="multipart/form-data">
            <div class="form-group row">
              <div class="col-sm-12">
                <div class="form-group">
              ...
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped" id="cursosinactivos">
                        <?php if(!empty($_POST)){
                      ...
                      <?php foreach ($cursos as $cr){ ?>
                          <tr class="text-center">
                            ...
                            <td class="table-active text-left">
                              <a href="<?php echo IP_SERVER."Cursos/cursosactivar/".$cr->curso_id; ?>" type="button" class="btn btn-outline-success" data-toggle="tooltip" data-placement="bottom" title="Activar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16">
