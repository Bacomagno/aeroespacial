...
<div class="breadcrumb-holder">
    <div class="container-fluid">
        ...
        <li class="breadcrumb-item active"><a href="<?php echo IP_SERVER ?>binactivos">Banners Activos</a></li>
        </ul>
    </div>
</div>
<section>
        <div class="container-fluid">
          <!-- Page Header-->
          <header>
            <h1 class="h3 display">Banners Inactivos            </h1>
          </header>
          <div class="form-group row">
                <div class="col-sm-12">
                  <div class="form-group">
                    <p>En esta sección encuentra en listado de los Baners Inactivos de la Sección Principal           </p>
                  </div>
                </div>
          </div>
          <form action="<?php echo IP_SERVER?>binactivos" method="POST" id="banner_fechas" enctype="multipart/form-data">
            <div class="form-group row">
              <div class="col-sm-12">
                <div class="form-group">
                      ...
                      <?php foreach ($banners as $b){ ?>
                          <tr class="text-center">
                            ...
                            <td class="table-active text-left">
                                <a href="<?php echo IP_SERVER."Banners/bannersactivar/".$b->banner_id; ?>" type="button" class="btn btn-outline-success" data-toggle="tooltip" data-placement="bottom" title="Activar"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check-square" viewBox="0 0 16 16">
